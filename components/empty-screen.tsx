  ...
  return (
    <div className="mx-auto max-w-2xl px-4">
      <div className="rounded-lg border bg-background p-8 mb-4">
        ...
        <p className="mb-2 leading-normal text-muted-foreground font-bold">
          By default all tools are turned on, but you can type @ in the chat
          input to select specific ones
        </p>
        <p className="mb-2 leading-normal text-muted-foreground">
